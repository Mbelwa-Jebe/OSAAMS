package com.touchizen.OSAAMS.models;
...
public class Advisor {
    ...
    public String getAdvisor_office() {
        return advisor_office;
    }

    public void setAdvisor_office(String advisor_office) {
        this.advisor_office = advisor_office;
    }
