...
public class Message_adapter_advisor extends RecyclerView.Adapter<Message_adapter_advisor.ViewHolder> {

    List<Message> list;
    Context context;
    private int SELF = 786;

    public Message_adapter_advisor(Context context, List<Message> list){
        this.list = list;
    ...
    @NonNull
    @Override
    public Message_adapter_advisor.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        ...
        return new Message_adapter_advisor.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull Message_adapter_advisor.ViewHolder holder, int position) {
