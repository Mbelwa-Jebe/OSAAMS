 ...
 // $registration_no = "1234";
  // $request_info = "voila";
   ...
   // $advisor_id = $OutputData['advisor_id'];
     $sql = "INSERT INTO `appointments` (`appointment_id`, `student_id`, `advisor_id`, `response`, `request_info`, `ap_from`, `ap_to`, `timestamp`) VALUES (NULL, '$student_id', '$registration_no', 'waiting', '$request_info','$registration_no','$student_id', current_timestamp())";
